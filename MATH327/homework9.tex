...
\end{enumerate}
\begin{description}
    \item \textbf{Answer:} $n_1=100$, $\hat{p}_1=0.1$, $n_2=100$, $\hat{p}_2=0.06$.\newline
    (a) $z_{0.025}=1.96$\newline
    $(0.1-0.06)\pm (1.96)\sqrt{\frac{0.1\cdot 0.9}{100}+\frac{0.06\cdot 0.94}{100}}=0.04\pm 0.075$\newline
    \boldmath$-0.035<p_1-p_2<0.115$.\newline
    (b) Interval contains 0, not enough evidence to suggest $p_1>p_2$.
\end{description}
\end{document}
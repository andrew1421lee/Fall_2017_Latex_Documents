...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{description}
        \item \textbf{The training course is effective.}
    \end{description}
    \item What hypothesis is she testing if she commits a
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{description}
        \item \boldmath$\alpha = P(X\leq 24 \mid p =0.6) = 0.0548$
    \end{description}
    \item Find the probability of committing a type II error
    for the alternatives $p = 0.3$, $p = 0.4$, and $p = 0.5$.
    \begin{description}
        \item \textbf{For }\boldmath$p=0.3$\textbf{: }\boldmath$\beta=P(X>3 \mid p=0.3)=1 - 0.6496 = 0.3504$.
        \item \textbf{For }\boldmath$p=0.4$\textbf{: }\boldmath$\beta=P(X>3 \mid p=0.4)=1 - 0.3823 = 0.6177$.
        \item \textbf{For }\boldmath$p=0.5$\textbf{: }\boldmath$\beta=P(X>3 \mid p=0.5)=1 - 0.1719 = 0.8281$.        
    \end{description}
\end{enumerate}

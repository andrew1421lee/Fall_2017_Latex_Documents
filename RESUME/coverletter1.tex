...
\end{hiringmgr}
    ...
    GPA of \gpa. During my previous years at \university, I worked on several personal 
    projects alongside my assigned work. I used what I have learned about concurrency and 
    data structures to create a online chat bot that could handle multiple requests at a time
    while requesting data from online servers. 
\end{document}
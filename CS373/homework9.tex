    ...
    \begin{enumerate}
        ...
        \begin{description}
            ...
            \begin{enumerate}[label=\arabic*.]
                \item Check if $d$ is a DFA, if not reject.
            ...
            If the compliment of $d$ is empty, meaning 
            \item $L(d)=\Sigma^*$, then $M$ rejects. Otherwise $M$ accepts. All conditions are 
            handled in $M$ so $M=$ Some$_{DFA}$.
        \end{description}
